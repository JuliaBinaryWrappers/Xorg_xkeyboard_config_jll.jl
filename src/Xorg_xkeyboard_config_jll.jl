module Xorg_xkeyboard_config_jll
...
if VERSION < v"1.3.0-rc4"
    ...
    error("Unable to import Xorg_xkeyboard_config_jll on Julia versions older than 1.3!")
end
...
artifacts = Pkg.Artifacts.load_artifacts_toml(artifacts_toml; pkg_uuid=UUID("33bec58e-1273-512f-9401-5d533626f822"))
...
if best_platform === nothing
    @debug("Unable to load Xorg_xkeyboard_config; unsupported platform $(triplet(platform_key_abi()))")
else
